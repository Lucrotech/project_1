...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Count matches between pet & classifier labels
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
        
        # Check if pet image label is a dog
        if results_dic[key][3] == 1:
            # Increment the number of dog images
            results_stats_dic['n_dogs_img'] += 1
            
            # Check if classifier label is a dog
            if results_dic[key][4] == 1:
                # Increment the number of correctly classified dog images
                results_stats_dic['n_correct_dogs'] += 1
            
            # Check if pet image label and classifier label match
            if results_dic[key][2] == 1:
                # Increment the number of correctly classified dog breeds
                results_stats_dic['n_correct_breed'] += 1
        
        else:
            # Increment the number of non-dog images
            results_stats_dic['n_notdogs_img'] += 1
            
            # Check if classifier label is not a dog
            if results_dic[key][4] == 0:
                # Increment the number of correctly classified non-dog images
