...
def get_input_args():
    ...
    # Define 3 command line arguments using add_argument() method
    ...
    parser.add_argument('--dogfile', type=str, default='dognames.txt', help='Text file that contains the names of all dogs')
    
    # Parse the command line arguments and return as an ArgumentParser object
